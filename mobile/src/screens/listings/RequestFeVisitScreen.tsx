...
const st = StyleSheet.create({
  ...
  infoCard: { backgroundColor: C.petrolLight, padding: S.lg, borderRadius: R.lg, marginBottom: S.lg, borderWidth: 1, borderColor: C.blueBorder },
  ...
  chipActive: { backgroundColor: C.petrolLight, borderColor: C.petrolMid },
