...
def _serialize_row(r, distance_km):
    ...
    return {
        ...
        "warranty_info": warranty_info or None,
        "battery_health": r.get("battery_health"),
        "age_suitability": r.get("age_suitability"),
        "hygiene_status": r.get("hygiene_status"),
        "has_charger": r.get("has_charger"),
        "has_earphones": r.get("has_earphones"),
        "seller_functional_attestation": r.get("seller_functional_attestation"),
